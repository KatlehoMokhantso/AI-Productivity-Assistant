...
An AI powered productive assistant designed to automate workplace tasks, including email generation, meeting summarization, and task planning.
ai, productivity,, automation, chatbot, python.
